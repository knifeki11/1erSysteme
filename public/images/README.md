...
| **Canti2.jpg** or **Canti2.png** | CantiPOS — Identification and payments section |
| **SmarC1.jpg** | SmartClub — Solution overview section |
| **RFID.jpg** | TagFlow — Solution overview section |
| **Gadj1.jpg** | TagFlow — How TagFlow Works section |
| **distr.jpg** | Distrex — Solution overview section |
| **dist1.jpg** | Distrex — Sales Force & Pre-Sales section |
...
If a CantiPOS image is missing, the page shows the section title as placeholder text until you add the file.
