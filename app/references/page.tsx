...
import { ReferencesFlipSection } from "@/components/references-flip-section"
...
export default function ReferencesPage() {
  ...
  const referencesPage = t.referencesPage as { heroHeadlineLine1?: string; heroHeadlineLine2?: string } | undefined
    ...
    <PageShell>
      <section id={PAGE_HERO_ID} className="relative flex h-screen min-h-0 items-center overflow-hidden" data-header-theme={isDark ? "inverted" : undefined}>
        ...
        <div className="relative z-10 w-full px-10 sm:px-16 md:px-20 lg:px-24 pointer-events-none">
          ...
          >
            {referencesPage?.heroHeadlineLine1 ?? "Trusted by"}
            <br />
            {referencesPage?.heroHeadlineLine2 ?? "leading organizations."}
          </h1>
          </div>
        </div>
      </section>
      <ReferencesFlipSection />
    </PageShell>
  )
}
